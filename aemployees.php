...
<div class="preloader">
    ...
    <div class="page">
                    ...
                    <div class="rd-navbar-inner-outer">
                        <div class="rd-navbar-inner">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <!-- RD Navbar Brand-->
                                <div  class="rd-navbar-brand"><a class="brand"style="width=1px; height=3px" href="adminHome.php"><img
                            ...
                            <div class="rd-navbar-right rd-navbar-nav-wrap">
                                ...
                                <div class="rd-navbar-main">
                                    ...
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="adminHome.php">Home</a>
                                        ...
                                        <li class="rd-nav-item active"><a class="rd-nav-link" href="aemployees.php">Employees</a></li>
        ...
        <a 
                                    ...
                                    href="empSign.php" data-caption-animate="fadeInUp" data-caption-delay="300">EMPLOYEE SIGN UP</a>
          <br><br>  <br> 
  ...
  <tbody>
    ...
    <?php
        $query1 = "Select Employee_ID , Employee_Name , Phone_No , Address , email from employee order by Employee_ID ";
        ...
        echo "<tr><td> $EmpID </td><td>$EmpName</td><td> $Phone </td><td> $Address </td>
        <td> $email </td></tr>" ;
