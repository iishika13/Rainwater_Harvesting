...
<div class="preloader">
    ...
    <div class="page">
                            ...
                            <div class="rd-navbar-right rd-navbar-nav-wrap">
                                ...
                                <div class="rd-navbar-main">
                                    ...
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="adminHome.php">Home</a>
                                        ...
                                        <li class="rd-nav-item active"><a class="rd-nav-link" href="ataskList.php">Tasklist</a></li>
        ...
        <a 
                                    ...
                                    href="taskADD.php" data-caption-animate="fadeInUp" data-caption-delay="300">Add Task</a>
          <br><br>  <br>                        
...
//   $empid = $_SESSION['Employee_ID'] ;
    ...
    echo "<tr><td>$employee_id</td><td> $title </td><td> $details </td><td> $city </td>
    <td> $road </td> <td> $bill</td><td>$status</td><td><a href='employeeTaskEdit.php?Unique_ID=$uniqueid&A=1'><button>Done</button> </a></td><td><a href='employeeTaskEdit.php?Unique_ID=$uniqueid&A=2'><button>Working</button> </a></td></tr>" ;
