...
<div class="preloader">
                            ...
                            <div class="rd-navbar-right rd-navbar-nav-wrap">
                                ...
                                <div class="rd-navbar-main">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li class="rd-nav-item active "><a class="rd-nav-link" href="cart.php"><span
  ...
  <tbody>
   ...
   // echo $company_name ;
    ...
    $query3 = "Select * from order_data JOIN purification ON order_data.Purification_ID = purification.Purification_ID Where User_ID = $userid ORDER BY order_data.Order_No " ;
    ...
    <td> $gallons </td> <td> $type</td><td><a href='cart.php?id=".$row['Order_No']."'> DELETE </a></td></tr>" ;
...
<from method = "POST">
<div >
<button style="background-color:#1165D4; color: balck; height: 60px; weight: 200px;" type="button" name="payment"><a href="billGen.php"><h6>Payment</h6></a></button>
  </form>
<Br><Br>
</div>
