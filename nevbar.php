                            ...
                            <div class="rd-navbar-right rd-navbar-nav-wrap">
                                        ...
                                        <li>
                                            <div class="unit unit-spacing-xs">
                                                ...
                                                <div class="unit-body"><a class="address"
                                                        href="https://www.google.com/maps/place/Gulshan,+Dhaka/@23.7897077,90.3929248,14z/data=!3m1!4b1!4m5!3m4!1s0x3755c7a0f70deb73:0x30c36498f90fe23!8m2!3d23.7924961!4d90.4078058">Gulshan
                                                        Dhaka Bangladesh</a></div>
                                            </div>
                                        </li>
                                    

                                        <li>
                                        <button type="button"  style= "background-color: white;" style="color:black;" class="btn btn-outline-info"><p style=" font-size:20px;">Logout  </p></button>
                                        </li>
                                ...
                                <div class="rd-navbar-main">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="">Orderlist</a></li>

                                        <li class="rd-nav-item"><a class="rd-nav-link" href="">Reviews</a></li>
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="">Statistics</a></li>
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="">Contact Us</a>

                                        <li class="rd-nav-item "><a class="rd-nav-link" href=""><span
                                                    class="icon mdi mdi-cart"></span><sup></sup>
                                            </a>
</li>
